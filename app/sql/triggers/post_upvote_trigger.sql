...
AS $$
BEGIN
    UPDATE public.posts SET upvotes_count = upvotes_count + 1 WHERE post_id = NEW.post_id;
    RETURN NEW;
END;
$$;
...
AS $$
BEGIN
    UPDATE public.posts SET upvotes_count = upvotes_count - 1 WHERE post_id = OLD.post_id;
    RETURN OLD;
END;
$$;
